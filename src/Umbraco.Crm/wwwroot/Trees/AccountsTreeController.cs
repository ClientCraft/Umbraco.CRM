...
[Tree("Umbraco.Crm", "accounts", TreeTitle = "Accounts", TreeGroup = "crmItemsGroup", SortOrder = 1)]
...
public class AccountsTreeController : TreeController
{
    ...
    public AccountsTreeController(ILocalizedTextService localizedTextService,
    ...
    protected override ActionResult<TreeNode> CreateRootNode(FormCollection queryStrings)
    {
        ...
        root.RoutePath = string.Format("{0}/{1}/{2}", "Umbraco.Crm", "accounts", "overview");
        // set the icon
