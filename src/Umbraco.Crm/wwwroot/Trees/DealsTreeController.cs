...
namespace Umbraco.Community.Umbraco.Crm.wwwroot.Trees;

    [Tree("Umbraco.Crm", "deals", TreeTitle = "Deals", TreeGroup = "crmItemsGroup", SortOrder = 1)]
[PluginController("UmbracoCrm")]
    public class DealsTreeController : TreeController
{

    private readonly IMenuItemCollectionFactory _menuItemCollectionFactory;

        public DealsTreeController(ILocalizedTextService localizedTextService,
    ...
    protected override ActionResult<TreeNode> CreateRootNode(FormCollection queryStrings)
    {
        ...
        root.RoutePath = string.Format("{0}/{1}/{2}", "Umbraco.Crm", "deals", "overview");
        // set the icon
