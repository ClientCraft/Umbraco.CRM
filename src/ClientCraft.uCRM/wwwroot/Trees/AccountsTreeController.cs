...
[Tree("ClientCraft.uCRM", "accounts", TreeTitle = "Accounts", TreeGroup = "crmItemsGroup", SortOrder = 1)]
...
public class AccountsTreeController : TreeController
{
    ...
    protected override ActionResult<TreeNode> CreateRootNode(FormCollection queryStrings)
    {
        ...
        root.RoutePath = string.Format("{0}/{1}/{2}", "ClientCraft.uCRM", "accounts", "overview");
        // set the icon
