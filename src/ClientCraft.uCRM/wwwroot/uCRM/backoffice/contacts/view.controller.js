angular.module("umbraco")
  .controller("ClientCraft.uCRM.Contacts.ViewController", function ($scope, $window, notificationsService, $location, $route, $routeParams, $http, editorService, overlayService) {
    var vm = this;
    ...
    vm.openCreateTaskSidebar = function () {
      editorService.open({
        ...
        view: "/App_Plugins/uCRM/backoffice/sidebars/createTask/create.html",
    ...
    vm.openEditTaskDrawer = function (task) {
      ...
      editorService.open({
        ...
        view: "/App_Plugins/uCRM/backoffice/sidebars/editTask/edit.html",
        size: "small",
        data: {
    ...
    vm.handleSeeAllDeals = function ($event) {
      ...
      overlayService.open({
        view: '/App_Plugins/uCRM/backoffice/dialogs/seeAllDeals/seeAllDeals.html',
        title: 'See all Deals',
    ...
    vm.handleCreateNote = function ($event) {
      ...
      editorService.open({
        ...
        view: "/App_Plugins/uCRM/backoffice/notes/create.html",
        size: "small", // Options: small, medium, large
        data: vm.contact,
        submit: function (model) {
          fetchLatestNotes();
    ...
    vm.handleCreateDeal = function ($event) {
      ...
      editorService.open({
        ...
        view: "/App_Plugins/uCRM/backoffice/deals/create.html",
        size: "small", // Options: small, medium, large
        data: vm.contact,
        submit: function () {
          fetchContact();
    ...
    vm.openEditContactDrawer = function () {
      editorService.open({
        ...
        view: "/App_Plugins/uCRM/backoffice/contacts/edit.html",
        size: "small", // Options: small, medium, large
        data: vm.contact,
        submit: function (model) {
