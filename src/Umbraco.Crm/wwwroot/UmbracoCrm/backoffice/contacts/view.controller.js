angular
  .module("umbraco")
  .controller(
    "Umbraco.Crm.Contacts.ViewController",
    function (
      $scope,
      $window,
      ...
      Object.defineProperty(vm, "contactCompanyNames", {
        get: function () {
          if (
            vm.contact &&
            vm.contact.companies &&
            vm.contact.companies.length
          ) {
            return vm.contact.companies
        ...
        $http
          .get(
            "https://foo.client-craft.com/contact/" +
              vm.contactId +
              "?include=companies,deals,owner,deputies,tags,photo"
          )
            ...
            vm.ancestors = [
              {
                name: "Contacts",
                id: null,
                link: "/Umbraco.Crm/contacts/overview",
              },
      ...
      let fetchLatestNotes = function () {
        $http
          .get("https://foo.client-craft.com/contact/1/note?page=1&per_page=3")
          .then(function (response) {
