...
[Tree("Umbraco.Crm", "leads", TreeTitle = "Leads", TreeGroup = "crmItemsGroup", SortOrder = 1)]
[PluginController("UmbracoCrm")]
public class LeadsTreeController : TreeController
{

    private readonly IMenuItemCollectionFactory _menuItemCollectionFactory;

    public LeadsTreeController(ILocalizedTextService localizedTextService,
    ...
    protected override ActionResult<TreeNode> CreateRootNode(FormCollection queryStrings)
    {
        ...
        root.RoutePath = string.Format("{0}/{1}/{2}", "Umbraco.Crm", "leads", "overview");
        // set the icon
