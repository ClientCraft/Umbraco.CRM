 ...
 */
export const getAccountDeals = <ThrowOnError extends boolean = false>(options: Options<GetAccountDealsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAccountDealsResponse, GetAccountDealsError, ThrowOnError>({
        ...options,
        url: '/account/{account}/deals'
    });
};
 ...
 */
export const createAccountDeal = <ThrowOnError extends boolean = false>(options: Options<CreateAccountDealData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAccountDealResponse, CreateAccountDealError, ThrowOnError>({
        ...options,
...
/**
 * Retrieve a specific deal for an account
 */
export const getAccountDeal = <ThrowOnError extends boolean = false>(options: Options<GetAccountDealData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAccountDealResponse, GetAccountDealError, ThrowOnError>({
        ...options,
        url: '/account/{account}/deal/{deal}'
    });
};

/**
 * Update a specific deal for an account
 */
export const updateAccountDeal = <ThrowOnError extends boolean = false>(options: Options<UpdateAccountDealData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAccountDealResponse, UpdateAccountDealError, ThrowOnError>({
        ...options,
        url: '/account/{account}/deal/{deal}'
    });
};
...
/**
 * Delete a specific deal for an account
 */
export const deleteAccountDeal = <ThrowOnError extends boolean = false>(options: Options<DeleteAccountDealData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAccountDealResponse, DeleteAccountDealError, ThrowOnError>({
        ...options,
        url: '/account/{account}/deal/{deal}'
    });
};
 ...
 */
export const getDealStatuses = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetDealStatusesResponse, GetDealStatusesError, ThrowOnError>({
        ...options,
        url: '/deal/statuses'
    });
};
 ...
 */
export const createDealStatus = <ThrowOnError extends boolean = false>(options: Options<CreateDealStatusData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateDealStatusResponse, CreateDealStatusError, ThrowOnError>({
        ...options,
        url: '/deal/status'
    });
};
...
/**
 * Update a specific deal status
 */
export const updateDealStatus = <ThrowOnError extends boolean = false>(options: Options<UpdateDealStatusData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateDealStatusResponse, UpdateDealStatusError, ThrowOnError>({
        ...options,
        url: '/deal/status/{status}'
    });
};

/**
 * Delete a specific deal status
 */
export const deleteDealStatus = <ThrowOnError extends boolean = false>(options: Options<DeleteDealStatusData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteDealStatusResponse, DeleteDealStatusError, ThrowOnError>({
        ...options,
        url: '/deal/status/{status}'
    });
};
